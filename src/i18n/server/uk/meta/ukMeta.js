...
const ukMeta = {
  ...
  'barrel-bag-mini': {
    ...
    description: `Малесенька сумка на кермо для дрібничок. Для щоденних поїздок. Підходить для марафонів, бреветів і на невеликі відстан`,
  },
  ...
  'barrelbag-with-velcro': {
    ...
    description: `Комфортна та містка сумка на кермо. Для будь яких дистанцій. Пдіходить для піших прогулянок. Система Molle дозволяє кріпити додаткові аксесуари`,
  },
  'bike-wallet': {
    title: 'Велогаманець',
    description: `Є відділення на липучку із кишеньками для карток. Ззовні водонепроникної блискавка. Петелька для кріплення до карабіна`,
  },
  'fuel-bag': {
  ...
  'chevron-lets-go': {
    ...
    description: `Оригінальний шеврон "Let\'s Go" для сумок, рюкзаків та одягу. Ідеально пасує до серії "Вело" разом із шевронами "Strava" та "Кава". Кріплення на велкро.`,
  },
  'chevron-strava': {
    title: 'Шеврон "Strava" – патч для велолюбителів',
    description: `Вишитий шеврон "Strava" для рюкзаків, сумок та одягу. Чудово пасує до шевронів "Кава" та "Let\'s Go". Ідеальний аксесуар для велосипедистів.`,
  },
  'chevron-velocats': {
    title: 'Шеврон "Велокотики" – патч для патріотів',
    description: `Вишитий патч "Велокотики" для велосипедистів, які захищають Україну. Легко кріпиться на рюкзаки, сумки чи одяг завдяки велкро.`,
  },
  'chevron-coffee': {
    title: 'Шеврон "Кава" – стильний велоаксесуар',
    description: `Вишитий шеврон "Кава" чудово доповнює серію "Вело" разом із "Strava" та "Let\'s Go". Легке кріплення на велкро для сумок та одягу.`,
  },
  'chevron-donut': {
    title: 'Шеврон "Пончик" – кавунський стиль',
    description: `Вишитий шеврон "Пончик" нагадує про сонячний південь України. Легке велкро-кріплення на рюкзаки, одяг та аксесуари.`,
  },
  'chevron-ghost': {
    title: 'Шеврон "Привид" – світловідбиваючий патч',
    description: `Вишитий на світловідбиваючій тканині, шеврон "Привид" стане ідеальним супутником у темну пору. Кріпиться на велкро.`,
  },
  'chevron-heart': {
    title: 'Шеврон "Сердечко" – кавуновий стиль',
    description: `Вишитий шеврон у формі кавунового серця – нагадування про сонячний південь. Легке велкро-кріплення для одягу, сумок та аксесуарів.`,
  },
  'chevron-slice': {
    title: 'Шеврон "Скибка" – кавуновий патч',
    description: `Вишитий шеврон "Скибка" нагадує про сонячний південь України. Легко кріпиться на одяг, сумки та аксесуари завдяки велкро.`,
  },
};
