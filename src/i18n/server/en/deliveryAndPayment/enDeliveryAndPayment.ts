const dictionary = {
  ...
  shippingAbroadFirstParagraph: `The situation with orders abroad is similar. Our manager contacts you, agrees on the details of the order, and agrees on the terms of execution. At this stage, the shipping cost is calculated depending on the country and agreed with you. This amount is added to the total order amount. For international delivery, we primarily work with Nova Poshta.`,
};
